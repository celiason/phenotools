...
```{r}
tmp1 <- buildnex(file = 'examples/Bertelli_Chiappe_2005.pdf', ntax = 34, nchar = 63, first = 20, last = 22)
# plot(tmp1, legend.pos = 'right')

pdf_text("examples/Bertelli_Chiappe_2005.pdf")
...
twig1 <- buildnex(file="data/theropods/brusatte2014_matrix.txt", charlabels="data/theropods/brusatte2014_charlist.txt")
twig2 <- buildnex(file="data/theropods/xu2011_matrix.txt", charlabels="data/theropods/xu2011_charlist.txt")
```
