...
### Test read.nex function (reading PDF and converting to a nexus object)

```{r}
tmp1 <- read.nex(file = system.file("extdata", "Bertelli_2005.pdf", package = "phenotools"), ntax = 34, nchar = 63, first = 20, last = 22)
tmp1
plot(tmp1)
...
tmp2 <- read.nex(pdffile = 'examples/Johnston_2011.pdf', ntax = 13, nchar = 57, first = 21, last = 24)
# plot(tmp2, legend.pos = 'right')

tmp3 <- read.nex(pdffile = 'example/Bertelli_2014.pdf', ntax = 56, nchar = 157, first = 24, last = 25)
# tmp3 <- sort(tmp3)
# plot(tmp3, legend.pos = 'right')

tmp4 <- read.nex(pdffile = 'example/Mayr_2003.pdf', ntax = 46, nchar = 148, first = 20, last = 24)
...
twig1 <- read.nex(file="~/Documents/UT/projects/phenome/data/theropods/brusatte2014_matrix.txt", charlabels="~/Documents/UT/projects/phenome/data/theropods/brusatte2014_charlist.txt")
twig2 <- read.nex(file="~/Documents/UT/projects/phenome/data/theropods/xu2011_matrix.txt", charlabels="~/Documents/UT/projects/phenome/data/theropods/xu2011_charlist.txt")
