...
#'
#' should have this output the string distances as well in the dup data frame @done
#' exclude most common words during matching @todo
#' exclude positional terms during matching @todo
#' exclude common words during matching @todo
#'
...
if (is.null(map)) {
  ...
  # @todo if state labels are absent/present (i.e. non-informative), then remove from duplicate matching
  # @todo Weight first few words (if comma) more heavily
